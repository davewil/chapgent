...
from pygent.session.models import Session, SessionSummary
...
class SessionStorage:
    ...
    def __init__(self, storage_dir: Path | None = None) -> None:
        if storage_dir:
            ...
            # Default to XDG compliant path: ~/.local/share/pygent/sessions/
            self.storage_dir = Path.home() / ".local" / "share" / "pygent" / "sessions"
